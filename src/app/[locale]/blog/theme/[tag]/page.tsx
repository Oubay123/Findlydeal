...
interface ThemePageProps {
  params: Promise<{ locale: UiLocale; tag: string }>;
}
...
export async function generateMetadata({ params }: ThemePageProps): Promise<Metadata> {
  ...
  return {
    title: `Blog : ${tag}`,
    description: `Tous nos articles sur le thème « ${tag} » : guides d'achat pratiques, conseils pour acheter au bon prix et méthodes pour repérer les vraies remises.`,
    alternates: localeAlternates(locale, `/blog/theme/${slug}`),
  };
}
